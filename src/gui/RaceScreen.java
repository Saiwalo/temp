...
public class RaceScreen extends Shell {
    public RaceScreen(Display display) {
        ...
        Composite primaryBG = new Composite(this, SWT.NONE);
        GridData gData = new GridData(GridData.FILL | GridData.HORIZONTAL_ALIGN_CENTER);
        primaryBG.setLayoutData(gData);
        primaryBG.setLayout(new GridLayout(1, true));
        
        gData = new GridData(SWT.CENTER, SWT.TOP, true, false);
        gData.horizontalAlignment = GridData.FILL;
        gData.horizontalSpan = 1;
        
        Label charName = new Label(primaryBG, SWT.CENTER);
        ...
        Composite dropDownPanel = new Composite(primaryBG, SWT.NONE);
        ...
        // Composite buttonPanel = new Composite(raceBG, SWT.NONE);
        ...
        Button prevButton = new Button(primaryBG, SWT.NONE);
